...
class MainProgram{
	...
	void DriverMenu(Driver CurrentDriver){
		printf("\n");
        printf(" *************************\n");
		...
		string Reward = CurrentDriver.GetReward();
		string Punishment = CurrentDriver.GetPunishment();

		scanf("%d", &input);
		switch(input){
			case 1:
				printf("%20s", CurrentDriver.GetReward().c_str());
				DriverMenu(CurrentDriver);
			case 2:
				printf("%20s", CurrentDriver.GetPunishment().c_str());
				DriverMenu(CurrentDriver);
			case 3:
				MainMenu();
			default:
